...
function getControlConflict(c, type) {
	...
	if ((type == "name" && c.name) || (type == "form" && c.formObject)) {
		...
		for (var i in controls) {
			...
			// check name or form 
			if (c.id != control.id && ((type == "name" && control.name && c.name == control.name) || (type == "form" && c.formObject == control.formObject && c.formObjectRole == control.formObjectRole && c.formObjectType == control.formObjectType && c.formObjectNumber == control.formObjectNumber))) {
				// get the control class
				var controlClass = _controlTypes[control.type];
			...
			for (var i in _pages) {
				...
				if (page.id != _page.id) {
					for (var j in page.controls) {
						...
						if (c.id != control.id && ((type == "name" && pc.name && c.name == pc.name) || (type == "form" && c.formObject == control.formObject && c.formObjectRole == control.formObjectRole && c.formObjectType == control.formObjectType && c.formObjectNumber == control.formObjectNumber))) {
							// get the control class
