...
public class Rapid extends RapidHttpServlet {
	...
	public static final String VERSION = "2.5.2"; // the master version of this Rapid server instance
	...
	public static final String JQUERY = "jquery-3.6.0.js"; // the version of jquery we have which we write into the pages, jquery ui is in each control
												...
												if (headerParts.length > 1) {
													...
													if (headerParts[0].toLowerCase().trim().equals("content-type")) {
														...
														if (contentParts.length > 1) {
															...
															// if we don't have the extension, derive it
															if (ext == null) ext = contentParts[1].toLowerCase().trim();
															// adjust jpeg to jpg
